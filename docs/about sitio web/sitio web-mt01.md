...
Mas allá de lograr configurarlo todo, me interesaba entender que tenía que ver una cosa con la otra y para qué era cada una: Git con Github y luego hacer un Fork; instalar Visual Studio para escribir en Markdown y porque necesitaba también instalar Mkdocs y qué es pip y también instalar Python y Markdown editor y un largo etcétera.
...
![Captura Pip3](../images/ASW/Screenshot-pip3.png)

Para mi, por momentos se sentía como que a alguien que está aprendiendo a tejer, decirle, agarrá las agujas y avisame cuando vayas en la carrera número 3, pero la persona todavía se está preguntando cómo se agarran las agujas!!
